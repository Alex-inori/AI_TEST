...
function renderRecentJobs(jobs) {
  ...
  jobs.forEach((job) => {
    ...
    copyBtn.innerHTML = `
      <svg class="copy-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" aria-hidden="true">
    ...
    if (jobUartPaths.length && isOwner) {
      ...
      uartBtn.innerHTML = `
        <svg class="uart-icon" viewBox="0 0 24 24" fill="none" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
